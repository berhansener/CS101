...
namespace PatikaHomeWorks
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine(DateTime.Now.ToString("ddd"));//günün kısaltması Thu  pzt gibi
            Console.WriteLine(DateTime.Now.ToString("dddd"));//günün tam hali Thursday  pazartesi
